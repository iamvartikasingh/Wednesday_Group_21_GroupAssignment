...
public class ConfigureABusiness {
        ...
        public static Business initialize() {
                ...
                UserAccount userAccount1 = business.getUserAccountDirectory().newUserAccount(salesPerson1, "sam",
                                "sam123");
                ...
                UserAccount userAccount2 = business.getUserAccountDirectory().newUserAccount(salesPerson2, "sally",
                                "sally123");
                ...
                UserAccount userAccount3 = business.getUserAccountDirectory().newUserAccount(salesPerson3, "steve",
                                "steve123");

                // MarketingPerson 1 - Mike
                Person person14 = new Person("Mike");
                MarketingPersonProfile marketingPerson1 = business.getMarketingPersonDirectory()
                                .newMarketingPersonProfile(person14);
                UserAccount userAccount4 = business.getUserAccountDirectory().newUserAccount(marketingPerson1, "mike",
                                "mike123");

                // MarketingPerson 2 - Mary
                Person person15 = new Person("Mary");
                MarketingPersonProfile marketingPerson2 = business.getMarketingPersonDirectory()
                                .newMarketingPersonProfile(person15);
                UserAccount userAccount5 = business.getUserAccountDirectory().newUserAccount(marketingPerson2, "mary",
                                "mary123");
